...
include_dirs = [
    ...
    np.get_include(),
    '../hnswlib/',  # Include the hnswlib directory
    './',           # Include current directory for bthenn.h
]
...
def cpp_flag(compiler):
    ...
    The c++17 is preferred over c++14 which is preferred over c++11.
    """
...
class BuildExt(build_ext):
    ...
    if os.environ.get("BTHENN_NO_NATIVE"):
    ...
    def build_extensions(self):
        ...
        if ct == 'unix':
            ...
            if not os.environ.get("BTHENN_NO_NATIVE"):
...
setup(
    name='bthenn',
    version=__version__,
    description='B-Tree with HENN (Hierarchical Navigable Small World) indexing',
    author='Your Name',
    url='https://github.com/your-repo/bthenn',
    long_description="""A Python binding for B-Tree with HENN indexing for efficient similarity search""",
